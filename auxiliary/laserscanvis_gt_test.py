...
class LaserScanVis:
    ...
    def __init__(self, scan, scan_gt, scan_names, label_names, label_names_gt, offset=0,
                 semantics=True, instances=False):
        self.scan = scan
        self.scan_gt = scan_gt
        self.scan_names = scan_names
        self.label_names = label_names
        self.label_names_gt = label_names_gt
        self.offset = offset
    ...
    def update_scan(self):
        ...
        if self.semantics:
            ...
            self.scan.colorize()
            self.scan_gt.open_label(self.label_names_gt[self.offset])
